...
ascii_banner = pyfiglet.figlet_format("Hand cricket")
print(ascii_banner, end="")
print("--by Sohan/brokiemag\n")
...
comp = r.randint(1,10)
you =int(input("Please Enter a Number between 1 and 10 *to determine the toss* : ")); 
tvalue= comp+you
print(f"the computer chose:- {comp}")
print(f"you chose:- {you}")
print(f"{comp}+{you}={tvalue}") 
if choice == "e":
    if tvalue%2==0:
        print("You WON") 
